...
const Topbar = () => {
  ...
  return (
    <div className='flex items-center justify-between bg-[#212121] fixed top-0 left-0 px-10 py-5 shadow-md w-screen h-[80px]'>
        <Link className='link hover:text-orange-500'>
        ...
        <div className='flex items-center gap-5'>
          {isUserPresent ? (
            <div className='flex items-center gap-5'>
              ...
              <button className='hover:text-orange-400 cursor-pointer border-2 border-white' onClick={() => {navigate("/login"); localStorage.clear(); window.location.reload()}} >Logout</button>
            </div>
          ) : <>
